...
// Cores do sistema (design tokens) e cores por página. Vale pro VEXO
// inteiro (todas as clínicas), não só a que está selecionada no momento —
// mesmo essa tela ficando dentro da rota de uma clínica específica na
// sidebar. "Timing de resposta da IA" NÃO mora aqui (nem o toggle geral,
// nem o delay ajustável) — fica inteiro em "Agente de IA" de cada
// clínica, pra não duplicar a mesma explicação em dois lugares.
