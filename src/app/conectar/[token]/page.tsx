...
// junto do fluxo OAuth até o callback marcar usedAt.
        ...
        <div className="rounded-2xl border border-vexo-border bg-vexo-surface p-6 text-center shadow-xl">
          {invalid ? (
            ...
            <>
              ...
              <p className="mt-2 text-sm text-vexo-muted">
                Autoriza o VEXO a consultar seus horários livres e criar os agendamentos
                automaticamente.
              </p>
              ...
              <a
                href={`/api/oauth/google-calendar/public-start?token=${link.token}`}
